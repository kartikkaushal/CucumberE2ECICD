 ...
 * 
 * String productName = "ZARA COAT 3"; WebDriverManager.chromedriver().setup();
 ...
 * driver.findElement(By.id("login")).click(); WebDriverWait wait = new
